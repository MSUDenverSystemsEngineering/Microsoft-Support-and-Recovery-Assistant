...
Try {
	...
	[string]$appName = 'Support and Recovery Assistant'
	[string]$appVersion = '17.0.4949.9'
	[string]$appArch = 'x86/x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '04/25/2022'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		If (-not $useDefaultMsi) { Show-InstallationPrompt -Message 'Microsoft Support and Recovery Assistant has been installed.' -ButtonRightText 'OK' -Icon Information -NoWait }
	}
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'Microsoft.Sara' -CloseAppsCountdown 60
